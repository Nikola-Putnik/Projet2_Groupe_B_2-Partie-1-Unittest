...
import CorrDiviseurs_Propres as correct # l’implémentation correcte
import diviseurs_propres as student # la solution de l’étudiant


class TestDiviseurs_Propres(unittest.TestCase):
    ...
    def test0_None(self):
        ...
        for n in args:
            try:
                student_ans = student.diviseurs_propres(n)
    ...
    def test1_abs_0(self):
        ...
        for n in args:
            try:
                ...
                self.fail("Votre fonction a provoqué l'exception {}: {} avec comme argument {}".format(type(e), e, n))
            correct_ans = correct.diviseurs_propres(n)
